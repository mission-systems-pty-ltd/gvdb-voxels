...
if ( GVDB_ROOT_DIR )
	...
	set ( GVDB_BIN_DIR "${GVDB_ROOT_DIR}/bin" CACHE PATH "Path to libraries" FORCE)	
	set ( GVDB_SHARE_DIR "${GVDB_ROOT_DIR}/bin" CACHE PATH "Path to share files" FORCE)	
	...
	_FIND_FILE ( LIST_DLL GVDB_LIB_DIR "libgvdb.dll" "libgvdb.so" OK_DLL )	
  	...
  	_FIND_FILE ( LIST_LIB GVDB_BIN_DIR "libgvdb.lib" "libgvdb.so" OK_LIB )
	...
	if ( (${OK_PTX} GREATER 0) AND (${OK_GLSL} GREATER 2) ) 
